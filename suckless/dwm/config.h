...
static const char col_olive[]       = "#8c945c";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_olive,  col_olive  },
};
...
static const char *togglemcmd[] = { "pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle", NULL };
...
static const Key keys[] = {
	...
	{ 0,    	         XF86XK_AudioMute, spawn,          {.v = togglemcmd } },
